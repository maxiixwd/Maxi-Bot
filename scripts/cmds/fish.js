  ...
  onStart: async function ({ api, args, message, event, usersData }) {
    try {
      ...
      if (args.length === 0) {
        ...
        await message.reply({ attachment: fs.createReadStream(imagePath), body: `You caught a ${caughtFish.name} worth ${caughtFish.price} bals!` });
        ...
        message.reply(`You sold your fish for a total of ${totalEarnings} bals!`);
